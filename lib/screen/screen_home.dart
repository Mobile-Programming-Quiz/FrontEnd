...
//   bool isStartButtonEnabled = false; // START 버튼 활성화 여부
//   User? currentUser;
//
//   @override
//   void initState() {
...
//
//         setState(() {
//           isStartButtonEnabled = (userScore == 0); // score가 0이면 활성화
//         });
//       }
//     } catch (e) {
//       print('사용자 score 확인 중 오류 발생: $e');
//     }
//   }
//
//
...
//     return [
//       HomeScreenContent(quizs: quizs, todaySubject: todaySubject, isStartButtonEnabled: isStartButtonEnabled,), // todaySubject 전달
//       RankingPageView(),
//       MyPageScreen(),
//     ];
//   }
...
//
//   HomeScreenContent({required this.quizs, required this.todaySubject, required this.isStartButtonEnabled,});
//
//   @override
//   Widget build(BuildContext context) {
...
//                     backgroundColor: isStartButtonEnabled
//                         ? Colors.deepPurple
//                         : Colors.grey, // 버튼 색상 제어
