...
import 'setting_pages/setting.dart'; // SettingsPage 파일 import
import 'setting_pages/mypage.dart'; // MyPage import
import 'setting_pages/member_info.dart'; // MemberInfoPage import
...
class MultiCirclePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final List<double> percentages = [0.5, 0.5, 0.15, 0.25, 0.1];
